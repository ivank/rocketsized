defmodule RocketsizedWeb.CoreComponents do
  @moduledoc """
  ...
  attr :variant, :string, default: "primary", values: ~w(soft primary secondary)
  ...
  attr :rest, :global,
    include: ~w(autocomplete cols disabled form list max maxlength min minlength
                pattern placeholder readonly required rows size step accept)
  ...
  def back(assigns) do
    ~H"""
    <div class="mt-16">
      <.link navigate={@navigate} class="btn btn-soft">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RocketsizedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RocketsizedWeb.Gettext, "errors", msg, opts)
    end
  end
