defmodule Rocketsized.Creator do
  @moduledoc """
  The Creator context.
  """
  ...
  @doc """
  Gets a single manufacturer with all the vehicles that it is related to.
  ...
  """
  def get_manufacturer_with_vehicles!(id) do
    Repo.get!(Manufacturer, id) |> Repo.preload([:vehicles])
  end
